...
export async function loadCarModel(url, opts = {}) {
  ...
  wrap.userData = { wheels: pivots, steeringWheel, liveryMap, paintMat: paintMat || fallback.paint, headMat: headMat || fallback.head, tailMat: tailMat || fallback.tail, source: url, triangles: countTriangles(model) };
  return wrap;
}
